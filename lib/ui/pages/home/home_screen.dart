...
import 'package:fashio/core/controllers/home_screen_controller.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CarouselSlider.builder(
                        ...
                        itemCount: homeScreenC.bannerList.value.length,
                        itemBuilder: (BuildContext context, int index,
                          ...
                          imageUrl:
                              homeScreenC.bannerList.value[index].imgOne[0].url,
                          subItem: Row(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return CategoryRound(
                                title: homeScreenC
                                    .categoryList.value[index].subcategoryname,
                                index: index,
                      ...
                      SizedBox(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return GestureDetector(
                              onTap: () {
                                productDetailC.id.value = homeScreenC
                                        .flashSaleList.value[index].sId ??
                                    '';
