...
//
//     final recommendedProducts = recommendedProductsFromJson(jsonString);

import 'dart:convert';

RecommendedProducts recommendedProductsFromJson(Map<String, dynamic> map) =>
    RecommendedProducts.fromJson(map);

String recommendedProductsToJson(RecommendedProducts data) =>
